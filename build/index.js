...
var Progress = function (_Component) {
  ...
  _createClass(Progress, [{
        ...
        if (this.props.showCompact !== undefined) {
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              "label",
              null,
              "Processing your requests, please wait... ",
            ...
            _react2.default.createElement("br", null),
            _react2.default.createElement("progress", { max: "100", value: this.state.percentageNumber }),
            " ",
            this.state.percentage
          );
        }
    ...
    value: function renderCompactMode() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("progress", { max: "100", value: this.state.percentageNumber }),
    ...
    key: "renderCustomTitle",
    value: function renderCustomTitle() {
    ...
    value: function renderSingleLine() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("progress", { style: this.props.progressBarStyle, max: "100", value: this.state.percentageNumber }),
        _react2.default.createElement(
          "label",
          null,
          this.state.percentage,
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.current !== prevState.currentItem) {
        ...
        if (nextProps.current === 1) {
          ...
          var delta = Math.abs(Date.now() - prevState.currentTime);
          var timeElapsed = prevState.timeElapsed + delta;
          var averageTimePerItem = timeElapsed / 1000 / nextProps.current;
          var percentageDec = (nextProps.current * 100 / prevState.totalItems).toFixed(1);
          var percentage = percentageDec + "%";
